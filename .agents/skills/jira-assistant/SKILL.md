...
1. **Check workspace rules first**: Look for Jira configuration in `.agents/rules/jira-config.mdc`
...
1. Check if workspace has `.agents/rules/jira-config.mdc` with Jira configuration
...
**Note for skill users:** To configure this skill for your workspace, create `.agents/rules/jira-config.mdc` with your project details.
